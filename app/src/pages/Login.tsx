		...
		<Flex align={"center"} justify={"center"}>
			<Stack spacing={8} mx={"auto"} maxW={"lg"} px={{ base: 0, md: 6 }}>
				<Stack align={"center"}>
					...
					<HStack spacing="1">
					<Text fontWeight={600} align={"center"}>Login Using The Credentials Sent To Your E-Mail!</Text>

						
					</HStack>
					<Text fontWeight={500} align={"center"}>*If You Haven't Filled Out Business Evaluation Quiz, Please Fill It Out To Receive Your Login Credentials!</Text>
