							...
							>
								...
								<Stack flex="0.33" alignItems={"end"}>
									...
									<Tag
										size="sm"
										colorScheme={
											(position.regularMarketPrice / position.purchasePrice) > 0 ? "green" : "red"
										}
									>
										{(((position.regularMarketPrice / position.purchasePrice)*100)-100) > 0 ? "+" : ""}
										{(((position.regularMarketPrice / position.purchasePrice)*100)-100).toFixed(2)}%
									</Tag>
								</Stack>
							</Flex>
						))}
